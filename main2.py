...
# --- Opções de Upgrade ---
UPGRADE_OPTIONS = {
    'health_up': {'title': "Vida Max +2", 'effect': lambda p: p.update_max_health(2)},
    'speed_up': {'title': "Velocidade +10%", 'effect': lambda p: p.update_speed_mult(0.1)},
    'damage_up': {'title': "Dano Base +1", 'effect': lambda p: p.update_base_damage(1)},
    'cooldown_redux': {'title': "Cooldowns -10%", 'effect': lambda p: p.update_cooldown_mult(-0.1)},
    'chama_z_up': {'title': "Explosão Chama Maior", 'effect': lambda p: p.upgrade_alien_attack('Chama', 'ataque_z', 'explosion_radius', 40)},
    '4bracos_smash_up': {'title': "Smash + Largo", 'effect': lambda p: p.upgrade_alien_attack('Quatro Braços', 'ataque_z', 'width', 50)},
    'xlr8_chain_up': {'title': "Ataque em Cadeia +1 Alvo", 'effect': lambda p: p.upgrade_alien_attack('XLR8', 'ataque_z', 'num_targets', 1)},
    'diamante_field_up': {'title': "Campo de Cristal +2s", 'effect': lambda p: p.upgrade_alien_attack('Diamante', 'ataque_x', 'duration', 2000)},
}
